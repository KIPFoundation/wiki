...
<h1 style="text-align:center">Fiduciary License Agreement 2.0</h1>
<h2 style="text-align:center">based on the <br/>
Individual Contributor exclusive License Agreement
<br/>(including the TRADITIONAL PATENT LICENSE OPTION)</h2>

Thank you for your interest in contributing to KIP Foundation's projects ("We" or "Us").
...
If You are an employee and have created the Contribution as part of your employment, You need to have Your employer approve this Agreement or sign the Entity version of this document. If You do not own the Copyright in the entire work of authorship, any other author of the Contribution should also sign this – in any event, please contact Us at [dev@kip.foundation](mailto:dev@kip.foundation)
...
More specifically and in strict accordance with the above paragraph, we agree to (sub)license the Contribution or any Materials containing, based on or derived from the Contribution only under the terms of the GPL-3.0 (including any right to adopt any future version of a license if permitted).
...
9.1 This Agreement and all disputes, claims, actions, suits or other proceedings arising out of this agreement or relating in any way to it shall be governed by the laws of Singapore excluding its private international law provisions.
